$(document).ready(function () {
  ...
  detailSlider.slideCls(
    '.detail-slider .cls-btn',
    '.detail-slider',
    '#detailOpen, #moDetailOpen'
  );
  detailSlider.slideCls(
    '.detail-btn-area .cancel-btn',
    '.detail-slider',
    '#detailOpen, #moDetailOpen'
  );
...
function allChked() {
  let allOfChkBox = document.querySelectorAll(
    '.detail-channel-area input[type="checkbox"]'
  );
